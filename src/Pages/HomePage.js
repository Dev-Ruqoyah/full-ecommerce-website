...
>>>>>>> refs/remotes/origin/main
      ...
      <section className="py-8 pt-12">
        <div className="container mx-auto">
          <div className="header flex gap-5 items-center">
            ...
            <div>
              <p className="text-red-800 text-md font-semibold">Today's</p>
            </div>
          </div>
          <div className="flashsales pt-3 w-full px-2 md:w-1/2">
            ...
            <div className="flex flex-nowrap overflow-x-scroll md:overflow-x-hidden md:grid md:grid-cols-4  justify-between gap-8 items-center">
              <div className="shrink-0 md:basis-1/4 pt-3 h-100 relative product-card">
                <div className="containe p-4 bg-slate-50 ">
                  <div className="card-header flex justify-between">
                    <div className="discount bg-red-600 flex items-center h-9 px-2 text-white rounded-md">
                      <p>-40%</p>
                    </div>
                    <div className="icons">
                      <svg
                  ...
                  <div className="card-contents flex flex-col items-center justify- w-full">
                    <img src="product1.png" alt="" />
                    <button class="add-to-cart-button bg-black text-white w-full py-2  absolute bottom-20 rounded-b-md left-0.5  cursor-pointer translate-x-50 ">
                      Add to Cart
                    </button>{" "}
                  </div>
                </div>
                <div className="py-2 flex flex-col  items-start">
                  ...
                  <div className="prices flex gap-3">
                    <p className="text-red-600"> $120</p>
                  ...
                  <div className="review flex gap-3">
                    ...
                    <p className="text-gray-300">(88)</p>
                  </div>
                </div>
              </div>
              <div className=" shrink-0 md:basis-1/4 pt-3 h-100 relative product-card">
                <div className="containe p-4 bg-slate-50 h-60 ">
                  <div className="card-header flex justify-between">
                    <div className="discount bg-red-600 flex items-center h-9 px-2 text-white rounded-md">
                      <p>-35%</p>
                    </div>
                  ...
                  <div className="card-contents flex flex-col items-center justify-end w-full">
              ...
              <div className="shrink-0  md:basis-1/4 pt-3 h-100 relative product-card">
                <div className="containe p-4 bg-slate-50 h-60">
                  ...
                  <div className="card-contents flex flex-col items-center justify-center w-full">
                ...
                <div className="py-2 flex flex-col  items-start">
                  ...
                  <div className="prices flex gap-3">
                    <p className="text-red-600"> $370</p>
                    <p className="text-gray-300 stroke-gray-300 line-through">
                      {" "}
                      $400
                    </p>
                  ...
                  <div className="review flex gap-3">
                    ...
                    <p className="text-gray-300">(99)</p>
                  </div>
                </div>
              </div>
              <div className=" shrink-0 w-1/2 md:w-full md:basis-1/4  pt-3 h-100 relative product-card md:me-0  me-32">
                <div className="containe p-4  bg-slate-50 h-60 ">
                  <div className="card-header flex justify-between">
                    <div className="discount bg-red-600 flex items-center h-9 px-2 text-white rounded-md">
                      <p>-25%</p>
                  ...
                  <div className="card-contents flex flex-col items-center justify-center w-full ">
                    <img src="product4.png" width={"36%"} alt="" />
                    <button class="add-to-cart-button bg-black text-white w-full py-2  absolute bottom-20 rounded-b-md left-0.5  cursor-pointer translate-x-50 ">
                      Add to Cart
                    </button>
                  </div>
                ...
                <div className="py-2 flex flex-col  items-start">
                  ...
                  <div className="prices flex gap-3">
                    <p className="text-red-600"> $340</p>
                    <p className="text-gray-300 stroke-gray-300 line-through">
                      {" "}
                      $400
                    </p>
      ...
      <section className="py-8">
        <div className="border-t container mx-auto ">
          <div className="container mx-auto">
            <div className="header flex gap-5 items-center pt-8">
              <div className="border h-10 w-5 bg-red-600 rounded-md"></div>
              <div>
                <p className="text-red-600 text-md font-semibold">Categories</p>
              </div>
            </div>
            <div className="categories-content py-3">
              <h3 className=" text-2xl font-semibold md:text-3xl pb-4 ">
                Browse By Categories
              </h3>
              <div className="flex overflow-x-scroll md:overflow-x-hidden md:grid md:grid-cols-6 gap-6 flex-nowrap">
                ...
                <div className="category1 w-1/2 md:w-full shrink-0 hover:bg-red-600 border ease-in duration-300 hover:text-white flex flex-col items-center gap-4 rounded-md py-8">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <div className="category1 w-1/2 md:w-full shrink-0 hover:bg-red-600 border ease-in duration-300 hover:text-white flex flex-col items-center gap-4 rounded-md py-8">
                  ...
                  <p className="text-xl ">Head Phones</p>
                </div>
                <div className="category1 w-1/2 md:w-full shrink-0 hover:bg-red-600 border ease-in duration-300 hover:text-white flex flex-col items-center gap-4 rounded-md py-8">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="border-t container mx-auto">
          <div className="container mx-auto">
            <div className="header flex gap-5 items-center pt-8">
              <div className="border h-10 w-5 bg-red-600 rounded-md"></div>
              <div>
                <p className="text-red-600 text-md font-semibold">This Month</p>
              </div>
            </div>
              ...
              <div className="product-cards ">
                <div className="flex flex-nowrap overflow-x-scroll md:overflow-x-hidden md:grid md:grid-cols-4  justify-between gap-8 items-center">
                  <div className="shrink-0 md:basis-1/4 pt-3 h-100 relative product-card">
                    ...
                    <div className="py-2 flex flex-col  items-start">
                      <h4 className="text-md font-semibold">The north coat</h4>
                      <div className="prices flex gap-3">
                        <p className="text-red-600"> $260</p>
                        <p className="text-gray-300 stroke-gray-300 line-through">
                          {" "}
                          $360
                        </p>
                      ...
                      <div className="review flex gap-3">
                        ...
                        <p className="text-gray-300">(65)</p>
                      </div>
                    </div>
                  </div>
                  <div className=" shrink-0 md:basis-1/4 pt-3 h-100 relative product-card">
                    <div className="containe p-4 bg-slate-50 h-60 ">
                      <div className="card-header flex justify-end">
                        <div className="discount bg-red-600 hidden items-center h-9 px-2 text-white rounded-md">
                          <p>-35%</p>
                        </div>
                        <div className="icons">
                          <svg
                  ...
                  <div className="shrink-0  md:basis-1/4 pt-3 h-100 relative product-card">
                    <div className="containe p-4 bg-slate-50 h-60">
                      ...
                      <div className="card-contents flex flex-col items-center justify-center w-full">
                        <img src="product7.png" width={"40%"} alt="" />
                        <button class="add-to-cart-button bg-black text-white w-full py-2  absolute bottom-20 rounded-b-md left-0.5  cursor-pointer translate-x-50 ">
                          Add to Cart
                        </button>
                      </div>
                    ...
                    <div className="py-2 flex flex-col  items-start">
                      <h4 className="text-md font-semibold">Small BookShelf</h4>
                      <div className="prices flex gap-3">
                  ...
                  <div className=" shrink-0 w-1/2 md:w-full md:basis-1/4  pt-3 h-100 relative product-card md:me-0  me-32">
                    ...
                    <div className="py-2 flex flex-col  items-start">
                      ...
                      <div className="prices flex gap-3">
                        <p className="text-red-600"> $160</p>
                        <p className="text-gray-300 stroke-gray-300 line-through">
                          {" "}
                          $170
                        </p>
      ...
      <section className="py-8">
        <div className="container mx-auto">
          <div className="header flex gap-5 items-center pt-8">
            <div className="border h-10 w-5 bg-red-600 rounded-md"></div>
            <div>
              <p className="text-red-600 text-md font-semibold">Our Product</p>
            </div>
          </div>
          <div className="product-content py-3">
            ...
            <div className="product-cards ">
              <div className="flex flex-nowrap overflow-x-scroll md:overflow-x-hidden md:grid md:grid-cols-4  justify-between gap-8 items-center">
                <div className="shrink-0 md:basis-1/4 pt-3 h-100 relative product-card">
                  <div className="containe p-4 bg-slate-50 h-64 ">
                    <div className="card-header flex justify-end">
                      <div className="discount hidden bg-red-600 items-center h-9 px-2 text-white rounded-md">
                        <p>-40%</p>
                      </div>
                    ...
                    <div className="card-contents flex flex-col items-center justify- w-full">
                      <img src="product9.png" width={"35%"} alt="" />
                      <button class="add-to-cart-button bg-black text-white w-full py-2  absolute bottom-14 rounded-b-md left-0.5  cursor-pointer translate-x-50 ">
                        Add to Cart
                      </button>{" "}
                    </div>
                  </div>
                ...
                <div className=" shrink-0 md:basis-1/4 pt-3 h-100 relative product-card">
                  <div className="containe p-4 bg-slate-50 h-64 py-4 ">
                    <div className="card-header flex justify-end">
                      <div className="discount bg-red-600 hidden items-center h-9 px-2 text-white rounded-md">
                        <p>-35%</p>
                      </div>
                    ...
                    <div className="card-contents flex flex-col items-center justify-start w-full">
                      <img src="product10.png" alt="" />
                      <button class="add-to-cart-button bg-black text-white w-full py-2  absolute bottom-14 rounded-b-md left-0.5  cursor-pointer translate-x-50 ">
                        Add to Cart
                      </button>
                    </div>
                ...
                <div className="shrink-0  md:basis-1/4 pt-3 md:mt-4 h-100 relative product-card">
                  <div className="containe p-4 bg-slate-50 h-64">
                    <div className="card-header flex justify-end">
                      <div className="discount bg-red-600 hidden items-center h-9 px-2 text-white rounded-md">
                        <p>-30%</p>
                ...
                <div className=" shrink-0 w-1/2 md:w-full md:basis-1/4 md:mt-4 pt-3 h-100 relative product-card ">
                  <div className="containe p-4  bg-slate-50 h-64 ">
                    <div className="card-header flex justify-end">
                      <div className="discount bg-red-600 hidden items-center h-9 px-2 text-white rounded-md">
                        <p>-25%</p>
                ...
                <div className=" shrink-0 w-1/2 md:w-full md:basis-1/4  h-100 relative product-card ">
                  <div className="containe p-4  bg-slate-50 h-64 ">
                    <div className="card-header flex justify-end">
                      <div className="discount bg-green-600   hidden items-center h-9 px-2 text-white rounded-md">
                        <p>New</p>
                      </div>
                      <div className="icons">
                        <svg
                    ...
                    <div className="card-contents flex flex-col items-center justify-center w-full ">
                      <img src="product14.png" alt="" />
                      <button class="add-to-cart-button bg-black text-white w-full py-2  absolute bottom-16 rounded-b-md left-0.5  cursor-pointer translate-x-50 ">
                        Add to Cart
                      </button>
                    </div>
                  </div>
                ...
                <div className=" shrink-0 w-1/2 md:w-full md:basis-1/4  h-100 relative product-card ">
                  <div className="containe p-4  bg-slate-50 h-64 ">
                    <div className="card-header flex justify-between">
                      <div className="discount bg-green-600   flex items-center h-9 px-2 text-white rounded-md">
                        <p>New</p>
                      </div>
                      <div className="icons">
                        <svg
                    ...
                    <div className="card-contents flex flex-col items-center justify-center w-full ">
                      <ImageChanger
                        initialImage="product15.png"
                        changedImage="product1.png"
                      />
                      <button class="add-to-cart-button bg-black text-white w-full py-2  absolute bottom-14 rounded-b-md left-0.5  cursor-pointer translate-x-50 ">
                        Add to Cart
                      </button>
                ...
                <div className=" shrink-0 w-1/2 md:w-full md:basis-1/4 h-100 relative product-card ">
                  <div className="containe p-4  bg-slate-50 h-64 ">
                    ...
                    <div className="card-contents flex flex-col items-center justify-center w-full ">
                      <ImageChanger
                        initialImage="product16.png"
                        changedImage="product5.png"
                      />
                      <button class="add-to-cart-button bg-black text-white w-full py-2  absolute bottom-14 rounded-b-md left-0.5  cursor-pointer translate-x-50 ">
                        Add to Cart
                      </button>
                  ...
                  <div className="py-2 flex flex-col  items-start">
                    ...
                    <div className="prices flex gap-3">
                      ...
                      <div className="review flex gap-3">
                        ...
                        <p className="text-gray-300">(66)</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-center mt-4">
                <button className="bg-red-600 hover:bg-red-700 px-8 py-3 text-white">
                  View All Products
                </button>
              </div>
            </div>
      ...
      <section className="py-8">
        <div className="container mx-auto">
          <div className="header flex gap-5 items-center pt-8">
            <div className="border h-10 w-5 bg-red-600 rounded-md"></div>
            <div>
              <p className="text-red-600 text-md font-semibold">Featured</p>
            </div>
          </div>
          <div className="month-content py-3">
            <h3 className=" text-2xl font-semibold md:text-3xl pb-4 ">
            ...
            <div className="grid md:grid-cols-2 gap-6 grid-cols-1 container mx-auto">
              <div
                ...
                style={{ backgroundImage: `url('ps.png')` }}
              >
      ...
      <section className="py-8">
        <div className="container mx-auto">
          <div className="flex md:flex-row  flex-col gap-6 md:gap-10 justify-evenly">
            ...
            <div className="fast flex-col items-center justify-center mx-auto">
              <div className="bg-gray-300 w-12 h-12 rounded-full p-2 mx-auto">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 p-1 bg-black rounded-full text-white">
  <path stroke-linecap="round" stroke-linejoin="round" d="M14.25 9.75v-4.5m0 4.5h4.5m-4.5 0 6-6m-3 18c-8.284 0-15-6.716-15-15V4.5A2.25 2.25 0 0 1 4.5 2.25h1.372c.516 0 .966.351 1.091.852l1.106 4.423c.11.44-.054.902-.417 1.173l-1.293.97a1.062 1.062 0 0 0-.38 1.21 12.035 12.035 0 0 0 7.143 7.143c.441.162.928-.004 1.21-.38l.97-1.293a1.125 1.125 0 0 1 1.173-.417l4.423 1.106c.5.125.852.575.852 1.091V19.5a2.25 2.25 0 0 1-2.25 2.25h-2.25Z" />
            ...
            <div className="fast flex-col items-center justify-center mx-auto">
              <div className="bg-gray-300 w-12 h-12 rounded-full p-2 mx-auto">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 p-1 bg-black text-white rounded-full">
