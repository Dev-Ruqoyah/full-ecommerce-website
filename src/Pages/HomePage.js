      ...
      <section className="py-8 pt-12">
        <div className="container mx-auto">
          <div className="header flex gap-5 items-center">
            ...
            <div>
              <p className="text-red-800 text-md">Today's</p>
            </div>
          </div>
          <div className="flashsales pt-3 w-1/2">
          ...
          <div className="product-cards">
            <div className="flex justify-between gap-8 items-center">
              <div className="basis-1/4 pt-3 h-100 ">
                <div className="containe p-4 bg-slate-50 h-60">
                  ...
                  <div className="card-contents flex items-center justify-center w-full">
              ...
              <div className="basis-1/4 pt-3 h-100">
                <div className="containe p-4 bg-slate-50 h-70">
                  <div className="card-header flex justify-between">
                    <div className="discount bg-red-600 flex items-center h-9 px-2 text-white rounded-md">
                      <p>-25%</p>
                    </div>
